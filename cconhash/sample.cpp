...
int main()
{
    ...
    {
        /* set nodes */
        conhash_set_node(&g_nodes[0],0, "titanic", 32);
        conhash_set_node(&g_nodes[1],1, "terminator2018", 24);
        conhash_set_node(&g_nodes[2],2, "Xenomorph", 25);
        conhash_set_node(&g_nodes[3],3, "True Lies", 10);
        conhash_set_node(&g_nodes[4],4, "avantar", 48);
        ...
        for(i = 0; i < 20; i++)
        {
            ...
            node = conhash_lookup(conhash, str, strlen(str));
